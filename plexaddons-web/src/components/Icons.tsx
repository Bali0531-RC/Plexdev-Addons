...
export const ShieldCheckIcon = ({ className, size = 20 }: IconProps) => (
  <svg {...base} className={className} width={size} height={size}>
...
export const InboxIcon = ({ className, size = 20 }: IconProps) => (
  <svg {...base} className={className} width={size} height={size}>
...
export const PaperclipIcon = ({ className, size = 16 }: IconProps) => (
  <svg {...base} className={className} width={size} height={size}>
