...
def upgrade() -> None:
    ...
    op.execute("DO $$ BEGIN CREATE TYPE releasechannel AS ENUM ('stable', 'beta', 'alpha'); EXCEPTION WHEN duplicate_object THEN NULL; END $$")
    op.execute("ALTER TABLE versions ADD COLUMN IF NOT EXISTS channel releasechannel NOT NULL DEFAULT 'stable'::releasechannel")
